          ...
          >
            ...
            <div className="order-1 md:order-2">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-linear-to-br from-[#0A2463] to-[#1E3A8A] p-6 rounded-2xl text-white transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold mb-2">2+</div>
                  <div className="text-sm text-blue-200">
                    Years of Excellence
                  </div>
                </div>
                <div className="bg-linear-to-br from-[#7EB23F] to-[#A8D47E] p-6 rounded-2xl text-white transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold mb-2">100+</div>
                  <div className="text-sm opacity-90">Happy Clients</div>
                </div>
                <div className="bg-linear-to-br from-[#06B6D4] to-[#0EA5E9] p-6 rounded-2xl text-white transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold mb-2">24/7</div>
                  <div className="text-sm text-cyan-100">Support Available</div>
                </div>
                <div className="bg-linear-to-br from-[#1E3A8A] to-[#0A2463] p-6 rounded-2xl text-white transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold mb-2">100%</div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="group premium-card bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:border-[#7EB23F]"
                >
                  <div
                    className={`w-14 h-14 bg-linear-to-br ${service.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
                    <svg
